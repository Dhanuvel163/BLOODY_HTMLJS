...
function samplesload(){
    ...
    const response =fetch('https://internshala-bloddy.herokuapp.com/api/useraccounts/rejectedrequests', {
    method: 'GET',
    headers: {
      ...
      response.json().then((res)=>{
          if(!res.success){
            ...
            if(res.bloods.length==0){
                document.getElementById('alertTextS').innerText='You have no rejected requests'
