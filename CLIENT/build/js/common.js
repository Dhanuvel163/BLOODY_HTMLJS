 function load(){
    let navListClear=document.getElementById('navList')
        navListClear.innerHTML=''
    if(isLogin()){
        ...
        <li class="nav-item" id="Samples">
            <a class="nav-link" href="/allSamples.html" >
    ...
    if(!isLogin()){
        ...
        <li class="nav-item" id="Samples">
            ...
            Samples</a>
                ...
                <li class="nav-item active" id="Hregister">
                    <a class="nav-link" href="/registerHosp.html">
                ...
                <li class="nav-item active" id="Rregister">
    ...
    if(isLogin() && loginType()){
        let navList=document.getElementById('navList')
        navList.innerHTML+=`
        <li class="nav-item" id="Asamples">
            <a class="nav-link" href="/addSamples.html" >
        ...
        <li class="nav-item"  id="Ysamples">
            <a class="nav-link" href="/hospSamples.html">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-clipboard-data" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/>
                <path fill-rule="evenodd" d="M9.5 1h-3a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
                <path d="M4 11a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1zm6-4a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7zM7 9a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0V9z"/>
        ...
        <li class="nav-item" id="requests">
            <a class="nav-link" href="/HospRequests.html">
        ...
        <li class="nav-item"  id="HArequests">
            <a class="nav-link" href="/acceptedHospRequests.html">
    ...
    if(isLogin() && !loginType()){
        let navList=document.getElementById('navList')
        navList.innerHTML+=`
        <li class="nav-item"  id="Yrequests">
            <a class="nav-link" href="/yourRequests.html">
        ...
        <li class="nav-item"  id="YArequests">
            <a class="nav-link" href="/acceptedUserRequest.html">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-check-fll" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984a.5.5 0 0 0-.708-.708L7 8.793 5.854 7.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"/>
                </svg>
            Accepted Requests</a>
        </li>
        <li class="nav-item"  id="YRrequests">
            <a class="nav-link" href="/rejectedUserRequest.html">
 ...
 function loginType(){
    let data=localStorage.getItem('hospital')=="true"?true:false;
    return data
}
